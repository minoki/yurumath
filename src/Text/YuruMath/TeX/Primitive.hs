...
import Text.YuruMath.TeX.Execution (CommonExecutable, CountReg, DimenReg, SkipReg, MuskipReg, ToksReg, executableDefinitions)
...
type NonExpandablePrimitiveList = '[CommonValue, CommonExecutable, MacroCommand, ExprCommand, TypesetCommand, BoxCommand, CountReg, DimenReg, SkipReg, MuskipReg, ToksReg]
